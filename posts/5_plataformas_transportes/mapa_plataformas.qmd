...
![](img/mapa_uber_99_brasil.png)A base de dados utilizada foi estruturada com informações municipais integradas a um shapefile via o pacote `{geobr}`. Os dados foram processados com a seguinte estrutura:
